...
function GuideLines() {
    ...
    const oddSteps = [
        ...
        },
        {
            ...
            desc: "Prepare Course Master, Student Master, Staff Course Mapping, Student Course Mapping, and Mentor Master data using the provided sample templates in the Input Files menu.",
